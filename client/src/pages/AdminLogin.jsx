  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative bg-white rounded-xl shadow-[0_4px_40px_rgba(0,101,101,0.10)] border border-outline-variant/10 p-8 w-full max-w-md">
        <h1 className="font-headline font-black text-2xl text-primary tracking-tight">Admin Portal</h1>
        <div className="w-8 h-0.5 bg-primary rounded-full mt-2 mb-6" />

        <form onSubmit={handleSubmit}>
          <p className="text-sm font-medium text-on-surface-variant mb-5">Sign in with your admin credentials.</p>
